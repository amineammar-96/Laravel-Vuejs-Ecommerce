...
<div class="funds-success-message-container">
  ...
  <div class="funds-success-message">
     ...
     <h2 >You will receive an email shortly to activate your email address</h2>
     <p>if you do not receive this email please check your spam</p>



    <router-link to="/" >   <button class="btn btn-dark px-4 py-1">Navigate</button>
</router-link>
  </div>
...
export default {
    ...
    mounted(){
        ...
        // axios.post('api/emailVerification' , this.user).then((response) => {
