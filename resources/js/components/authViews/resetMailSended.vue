...
<div class="funds-success-message-container">
  ...
  <div class="funds-success-message">
     ...
     <h2 v-if="!passwordChanged">You will receive an email shortly to create a new password</h2>
   <p  v-if="!passwordChanged" >if you do not receive this email please check your spam</p>





    <h2 v-if="passwordChanged">Your password has been changed successfully </h2>
   <p  v-if="passwordChanged" >Now you will be able to connect to your account</p>
    <router-link to="/login" >   <button class="btn btn-dark px-4 py-1">Login</button>
</router-link>
  </div>
