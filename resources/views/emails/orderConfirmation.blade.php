        ...
        <div class="container">
            ...
            <div class="receipt">
              ...
              <div class="receipt_receipt">
                <h1 class="red">Your order is <span>on its way</span> to you</h1>
                ...
                <div class="receipt_receipt_shipping">
                  <div class="receipt_receipt_shipping_left">
                    ...
                    <div class="receipt_receipt_shipping_left_to">
                      <span>{{ $details['userProfile']->name }}</span>
                      <span>{{ $details['userProfile']->email }}</span>
                      <span>{{ $details['userDefaultAddress']->phone  }}</span>
                      <span>{{ $details['userDefaultAddress']->address  }}</span>
                      <span>{{ $details['userDefaultAddress']->addressComp ?? ''  }}</span>
                      <span>{{ $details['userDefaultAddress']->country }}
,
                     {{ $details['userDefaultAddress']->city }} {{ $details['userDefaultAddress']->postalCode }}</span>

                    </div>
                    <div class="fluidText"><a href="#" class="red strong">Click here to update your adress.</a></div>
                  </div>
                  <div class="receipt_receipt_shipping_right">
                    <h4 class="dark">Shipping To:</h4>
                    <span> {{ $details['shippingInfo']->name }} </span>
                    <span> {{ $details['shippingInfo']->address }} </span>
                    <span> {{ $details['shippingInfo']->addressComp ?? '' }} </span>
                    <span> {{ $details['shippingInfo']->country }} , {{ $details['shippingInfo']->city }}
                        {{ $details['shippingInfo']->postalCode }} </span>
                ...
                <div class="receipt_receipt_items">
                  ...
                  @foreach ($details['orderInfo']->order_items as $item)
                ...
                <div class="receipt_receipt_total dark">
                  ...
                  <div class="receipt_receipt_total_tax">
                    <p>Tax:</p><p>${{ (($details['orderInfo']->amount)/100)*20 }}</p>
                  </div>

                  <div class="receipt_receipt_total_total">
                    <p>TOTAL HT:</p><p>${{  $details['orderInfo']->amount-((($details['orderInfo']->amount)/100)*20) }}</p>
                  </div>
                  <div class="receipt_receipt_total_total">
                    <p>TOTAL:</p><p>${{ $details['orderInfo']->amount }}</p>
                  </div>
                </div><!--close total-->
              </div>
            </div>
    ...
    <table
        ...
        <thead>
            ...
            <tr>
                ...
                <th style="text-align:left;font-weight:400;">{{ $details['orderInfo']->created_at }}</th>
            </tr>
        </thead>
        <tbody>
            <tr>
